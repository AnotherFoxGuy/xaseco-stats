...
<table width="100%" bgcolor="<?php echo $bg4 ?>" border="0" align="center">
  ...
  <tr valign="middle" <?php echo "bgcolor=".$bg2." onMouseOver=\"this.style.backgroundColor='".$bg3."'\" onMouseOut=\"this.style.backgroundColor='".$bg2."'" ?>">
    <td class="celltext-rb"><?php echo $lng_stats_c_atime ?>&nbsp;</td>
    <td class="celltext-l">&nbsp;<?php echo $atime ?></td>
  </tr>
  <tr valign="middle" <?php echo "bgcolor=".$bg1." onMouseOver=\"this.style.backgroundColor='".$bg3."'\" onMouseOut=\"this.style.backgroundColor='".$bg1."'" ?>">
    <td class="celltext-rb"><?php echo $lng_stats_c_gtime ?>&nbsp;</td>
    <td class="celltext-l">&nbsp;<?php echo $gtime ?></td>
  </tr>
  <tr valign="middle" <?php echo "bgcolor=".$bg2." onMouseOver=\"this.style.backgroundColor='".$bg3."'\" onMouseOut=\"this.style.backgroundColor='".$bg2."'" ?>">
    <td class="celltext-rb"><?php echo $lng_stats_c_stime ?>&nbsp;</td>
    <td class="celltext-l">&nbsp;<?php echo $stime ?></td>
  </tr>
  <tr valign="middle" <?php echo "bgcolor=".$bg1." onMouseOver=\"this.style.backgroundColor='".$bg3."'\" onMouseOut=\"this.style.backgroundColor='".$bg1."'" ?>">
    <td class="celltext-rb"><?php echo $lng_stats_c_btime ?>&nbsp;</td>
    <td class="celltext-l">&nbsp;<?php echo $btime ?></td>
  </tr>
  <tr valign="middle" <?php echo "bgcolor=".$bg2." onMouseOver=\"this.style.backgroundColor='".$bg3."'\" onMouseOut=\"this.style.backgroundColor='".$bg2."'" ?>">
