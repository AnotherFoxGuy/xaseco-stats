...
print "<table width=\"100%\" border=\"0\" bgcolor=\"$bg4\" align=\"center\">
  <tr bgcolor=\"$resultbg\">
    ...
    <td width=\"100\" class=\"tablehead\"><a href=\"".sprintf($sorturl, "Rank")."\">$lng_trecords_score</a></td>
  </tr>";
...
if ($totalrows < 1) {
   ...
   while($data = mysql_fetch_array($result))
   {
      ...
      echo "<td class=\"celltext\"><a href=\"?serv=".$serv."&lang=".$lang."&page=stprecords&plid=".$data['PlayerId']."\" class=\"celltext\">".$cp->toHTML($data['NickName'])."</a></td>";
